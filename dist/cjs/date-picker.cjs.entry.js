...
const JanusDatePicker = class {
    constructor(hostRef) {
        ...
        this.newValue = index.createEvent(this, "newValue", 7);
    }
    render() {
        return (index.h("div", { class: this.getClassMain(), id: "janus-datepicker" }, index.h("input", { type: "text", class: "janus-datepicker__input", value: this.value, readOnly: true, placeholder: this.placeholder, disabled: this.disable || this.lock, onFocus: (e) => this.handleFocus(e) }), index.h("div", { class: "janus-datepicker__wrapper-icon" }, index.h("p-janus-svg", { name: "CALENDAR", viewbox: "0 0 16 18", width: "16", height: "18" })), index.h("div", { class: this.getClassPanel(), tabindex: "10" }, index.h("div", { class: this.getClassPanelMultiYear() }, index.h("div", { class: "janus-datepicker__panel-header" }, index.h("div", { class: "content-center" }, index.h("p-janus-svg", { name: "ARROW_LEFT", viewbox: "0 0 13 12", width: "13", height: "12", onClick: (ev) => this.resetPanelYearsLeft(ev) })), index.h("div", null, this.arrayYears[0], " - ", this.arrayYears[this.arrayYears.length - 1]), index.h("div", { class: "content-center" }, index.h("p-janus-svg", { name: "ARROW_RIGTH", viewbox: "0 0 13 12", width: "13", height: "12", onClick: (ev) => this.resetPanelYearsRigth(ev) }))), index.h("div", { class: "janus-datepicker__panel-body" }, this.arrayYears.map((item) => index.h("div", { class: "janus-datepicker__item-wrapper" }, this.yearAfterNow(item) ?
            index.h("a", { class: "janus-datepicker__item janus-datepicker__item--disable" }, item) :
            this.selectYear == item && this.selectedDate ?
                index.h("a", { class: "janus-datepicker__item janus-datepicker__item--active", onClick: e => this.clickMultiYear(e, item) }, item) :
                index.h("a", { class: "janus-datepicker__item", onClick: e => this.clickMultiYear(e, item) }, item))))), index.h("div", { class: this.getClassPanelMonths() }, index.h("div", { class: "janus-datepicker__panel-header--center" }, index.h("div", { class: "janus-datepicker__button", onClick: (ev) => this.createMultiYear(ev) }, this.selectYear)), index.h("div", { class: "janus-datepicker__panel-body" }, this.arrayMonths.map((item) => index.h("div", { class: "janus-datepicker__item-wrapper" }, this.monthAfterNow(item.id) ?
            index.h("a", { class: "janus-datepicker__item janus-datepicker__item--disable" }, item.description) :
            this.selectMonth == item.value && this.selectedDate ?
                index.h("a", { class: "janus-datepicker__item janus-datepicker__item--active", onClick: e => this.clickMonth(e, item) }, item.description) :
                index.h("a", { class: "janus-datepicker__item", onClick: e => this.clickMonth(e, item) }, item.description))))), index.h("div", { class: this.getClassPanelDays() }, index.h("div", { class: "janus-datepicker__panel-header" }, index.h("div", { class: "content-center" }, index.h("p-janus-svg", { name: "ARROW_LEFT", viewbox: "0 0 13 12", width: "13", height: "12", onClick: (ev) => this.resetPanelDaysLeft(ev) })), index.h("div", null, index.h("a", { class: "janus-datepicker__button", onClick: () => this.createMonths() }, this.arrayMonths[this.selectMonth - 1].description), " -", index.h("a", { class: "janus-datepicker__button", onClick: (ev) => this.createMultiYear(ev) }, this.selectYear)), index.h("div", { class: "content-center" }, this.selectMonth == this.currentMonth && this.selectYear == this.currentYear ?
            index.h("p-janus-svg", { name: "ARROW_RIGTH", viewbox: "0 0 13 12", width: "13", height: "12" }) :
            index.h("p-janus-svg", { name: "ARROW_RIGTH", viewbox: "0 0 13 12", width: "13", height: "12", onClick: (ev) => this.resetPanelDaysRigth(ev) }))), index.h("div", { class: "janus-datepicker__panel-header-week" }, this.arrayDaysOfWeek.map((item) => index.h("div", null, item.description))), index.h("div", { class: "janus-datepicker__panel-body-days" }, this.arrayDays.map((item) => index.h("div", { class: "janus-datepicker__item-day-wrapper" }, this.dayAfterNow(item) ?
            index.h("a", { class: "janus-datepicker__item-day janus-datepicker__item-day--disable" }, item) :
            this.value && this.selectDay == item && this.selectedDate ?
                index.h("a", { class: "janus-datepicker__item-day janus-datepicker__item-day--active", onClick: e => this.clickDay(e, item) }, item) :
                index.h("a", { class: "janus-datepicker__item-day", onClick: e => this.clickDay(e, item) }, item))))))));
    }
    componentWillLoad() {
...
exports.date_picker = JanusDatePicker;

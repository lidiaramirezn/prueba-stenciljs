    ...
    render() {
        return (index.h("div", null, index.h("div", { class: this.getClassMain(), id: "janus-datepicker" }, index.h("input", { type: "text", class: "janus-datepicker__input", value: this.value, readOnly: true, placeholder: this.placeholder, disabled: this.disable || this.lock, onFocus: (e) => this.handleFocus(e) }), index.h("div", { class: "janus-datepicker__wrapper-icon" }, index.h("p-janus-svg", { name: "CALENDAR", viewbox: "0 0 16 18", width: "16", height: "18" })), index.h("div", { class: this.getClassPanel(), tabindex: "10" }, index.h("div", { class: this.getClassPanelMultiYear() }, index.h("div", { class: "janus-datepicker__panel-header" }, index.h("div", { class: "content-center" }, index.h("p-janus-svg", { name: "ARROW_LEFT", viewbox: "0 0 13 12", width: "13", height: "12", onClick: (ev) => this.resetPanelYearsLeft(ev) })), index.h("div", null, this.arrayYears[0], " - ", this.arrayYears[this.arrayYears.length - 1]), index.h("div", { class: "content-center" }, index.h("p-janus-svg", { name: "ARROW_RIGTH", viewbox: "0 0 13 12", width: "13", height: "12", onClick: (ev) => this.resetPanelYearsRigth(ev) }))), index.h("div", { class: "janus-datepicker__panel-body" }, this.arrayYears.map((item) => index.h("div", { class: "janus-datepicker__item-wrapper" }, this.yearAfterNow(item) ?
            ...
            this.value && this.selectDay == item && this.selectedDate ?
                ...
                index.h("a", { class: "janus-datepicker__item-day", onClick: e => this.clickDay(e, item) }, item))))))), index.h("div", { id: "area", class: "area" }, "area")));
    }
    componentWillLoad() {
